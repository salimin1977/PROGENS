...
export const getSchoolKPIs = async (): Promise<KPI[]> => {
  const [students, interventions, storedKpis] = await Promise.all([
    mockDataProvider.getStudents(),
    mockDataProvider.getInterventions(),
    mockDataProvider.getKPIs(),
  ]);
  ...
  return [
    {
      ...
      category: 'Academic',
      label: 'GPS Semasa',
      current: school.gpsCurrent,
      target: school.gpsTarget,
      unit: 'gps',
    ...
    },
    {
      ...
      category: 'Student',
      label: 'Jumlah Murid',
      current: school.totalStudents,
      target: school.totalStudents,
      unit: 'count',
      higherIsBetter: true,
    },
    {
      id: 'STUDENTS_AT_RISK',
      category: 'Risk',
      label: 'Murid Berisiko',
      current: school.studentsAtRisk,
      target: 0,
      unit: 'count',
      higherIsBetter: false,
    },
    {
      id: 'ACTIVE_INTERVENTIONS',
      category: 'Intervention',
      label: 'Intervensi Aktif',
      current: school.activeInterventions,
      target: 0,
      unit: 'count',
      higherIsBetter: false,
    },
    {
      ...
      category: 'Attendance',
      label: 'Kehadiran',
      current: Math.round(attendance * 10) / 10,
      target: 95,
      unit: '%',
      higherIsBetter: true,
    },
    {
      id: 'EXCELLENCE_STUDENTS',
      category: 'Student',
      label: 'Murid Cemerlang',
      current: school.excellenceStudents,
      target: 0,
      unit: 'count',
      higherIsBetter: true,
    },
